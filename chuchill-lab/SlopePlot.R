...
data <- read_csv("/projects/churchill-lab/projects/JAC/Takemon_DO_crosssectional_kidney/results/ANOVA/kidney_anova_slope_output.csv")
...
pdf("/projects/churchill-lab/projects/JAC/Takemon_DO_crosssectional_kidney/results/Plots/Slope/AgeSlope.pdf", height = 6, width = 6)
SlopePlot
dev.off()
