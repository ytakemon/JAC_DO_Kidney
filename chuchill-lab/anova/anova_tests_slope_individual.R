...
input.file = list.files(path = "/projects/churchill-lab/projects/JAC/Takemon_DO_crosssectional_kidney/data/Rdata/", pattern = paste0("^",args[[1]]),
                         recursive = TRUE,
                       full.names = TRUE)
...
dir <- "/projects/churchill-lab/projects/JAC/Takemon_DO_crosssectional_kidney/results/ANOVA/"
...
table(p.output$sig.prot_Age.Sex)
