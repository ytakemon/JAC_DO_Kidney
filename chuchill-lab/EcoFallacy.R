...
######################################
load("/projects/churchill-lab/projects/JAC/Takemon_DO_crosssectional_kidney/data/Rdata/RNAseq_data/DO188b_kidney_201802_YT.Rdata")
ls()
...
library(gridExtra)
pdf("/projects/churchill-lab/projects/JAC/Takemon_DO_crosssectional_kidney/results/Plots/Slope/Figure3_EcoFallacy.pdf", width = 5, height = 10)
