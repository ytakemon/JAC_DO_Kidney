...
write.csv(go_result, "./results/Pathways/PROT_EnrichGObp_Age.csv", row.names = FALSE)
...
write.csv(go_result, "./results/Pathways/PROT_EnrichGOcc_Age.csv", row.names = FALSE)
...
write.csv(kegg_result, "./results/Pathways/PROT_EnrichKEGG_Age.csv", row.names = FALSE)
