...
write.csv(go_result, "./results/Pathways/RNA_EnrichGObp_Sex.csv", row.names = FALSE)
# GO:CC
...
write.csv(go_result, "./results/Pathways/RNA_EnrichGOcc_Sex.csv", row.names = FALSE)
...
write.csv(kegg_result, "./results/Pathways/RNA_EnrichKEGG_Sex.csv", row.names = FALSE)
