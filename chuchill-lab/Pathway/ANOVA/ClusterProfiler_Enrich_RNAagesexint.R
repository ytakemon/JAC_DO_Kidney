...
sig <- AnovResults[AnovResults$sig.mRNA_AgeSexInt== TRUE,]
...
write.csv(go_result, "./Pathways/RNA_EnrichGObp_AgeSexInt.csv", row.names = FALSE)
# GO: CC
...
write.csv(go_result, "./Pathways/RNA_EnrichGOcc_AgeSexInt.csv", row.names = FALSE)
...
write.csv(kegg_result, "./Pathways/RNA_EnrichKEGG_AgeSexInt.csv", row.names = FALSE)
