...
load("/projects/churchill-lab/projects/JAC/Takemon_DO_crosssectional_kidney/data/Rdata/DO188b_kidney_noprobs.RData")
Upheno <- read.delim("/projects/churchill-lab/projects/JAC/Takemon_DO_crosssectional_kidney/data/JAC_CS_urine_chem_v1.txt", sep = "\t")
...
pdf("/projects/churchill-lab/projects/JAC/Takemon_DO_crosssectional_kidney/results/Plots/Phenotype/Slc34_global_expression.pdf", height = 5, width =7)
grid.arrange(Slca1_m,Slca1_p,Slca3_m,Slca3_p, ncol = 2)
dev.off()

###\. Individual age group changes
pdf("/projects/churchill-lab/projects/JAC/Takemon_DO_crosssectional_kidney/results/Plots/Phenotype/Slc34_byAge_expression.pdf", height = 3, width =7)
grid.arrange(Slca1_mp,Slca3_mp, ncol = 2)
dev.off()


###\. *Slc34a1* and  *Slc34a3* compared to urinary phosphate levels
pdf("/projects/churchill-lab/projects/JAC/Takemon_DO_crosssectional_kidney/results/Plots/Phenotype/Slc34_uPheno.pdf", height = 3, width =7)
grid.arrange(Slca1_pPhos,Slca3_pPhos, ncol = 2)
dev.off()

##\. *Lrp2* (Megalin)
###\. Global changes with age
pdf("/projects/churchill-lab/projects/JAC/Takemon_DO_crosssectional_kidney/results/Plots/Phenotype/Lrp2_global_expression.pdf", height = 3, width =7)
grid.arrange(Lrp2_m,Lrp2_p, ncol = 2)
dev.off()

###\. Individual age group changes
pdf("/projects/churchill-lab/projects/JAC/Takemon_DO_crosssectional_kidney/results/Plots/Phenotype/Lrp2_byAge_expression.pdf", height = 3, width =4)
print(Lrp2_mp)
dev.off()


###\. *Lrp2* and urinary albumin levels
pdf("/projects/churchill-lab/projects/JAC/Takemon_DO_crosssectional_kidney/results/Plots/Phenotype/Lrp2_uPheno.pdf", height = 3, width =4)
print(Lrp2_mp)
dev.off()
