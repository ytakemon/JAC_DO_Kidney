...
best <- read.csv("/projects/churchill-lab/projects/JAC/Takemon_DO_crosssectional_kidney/results/QTLscan/protein/BestMarker_AgeInt_protein_nobatch.csv")
...
pdf("/projects/churchill-lab/projects/JAC/Takemon_DO_crosssectional_kidney/results/Plots/QTLscan/pQTL_BestMarker_ageint.pdf", height = 8, width = 7)
