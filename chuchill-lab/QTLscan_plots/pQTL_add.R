...
# R/3.4.1
pQTL_best <- read.csv("/projects/churchill-lab/projects/JAC/Takemon_DO_crosssectional_kidney/results/QTLscan/protein/BestMarker_add_protein_nobatch.csv")
...
pdf("/projects/churchill-lab/projects/JAC/Takemon_DO_crosssectional_kidney/results/Plots/QTLscan/pQTL_BestMarker_additive.pdf", height = 8, width = 7)
