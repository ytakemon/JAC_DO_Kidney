...
m_best <- read.csv("/projects/churchill-lab/projects/JAC/Takemon_DO_crosssectional_kidney/results/QTLscan/mRNA/BestMarker_AgeInt_mrna.csv")
...
pdf("/projects/churchill-lab/projects/JAC/Takemon_DO_crosssectional_kidney/results/Plots/QTLscan/eQTL_BestMarker_ageint.pdf", height = 8, width = 7)
