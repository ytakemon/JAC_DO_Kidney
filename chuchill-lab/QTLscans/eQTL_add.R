...
eQTL_best <- read.csv("/projects/churchill-lab/projects/JAC/Takemon_DO_crosssectional_kidney/results/QTLscan/mRNA/BestMarker_add_mrna.csv")
...
pdf("/projects/churchill-lab/projects/JAC/Takemon_DO_crosssectional_kidney/results/Plots/QTLscan/eQTL_BestMarker_additive.pdf", height = 8, width = 7)
pushViewport(viewport( layout = grid.layout(10,10)))
print(mPlot, vp = viewport(layout.pos.row = 1:8, layout.pos.col = 1:10))
print(mdensity, vp = viewport(layout.pos.row = 9:10, layout.pos.col = 1:10))
dev.off()
