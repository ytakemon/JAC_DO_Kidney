...
expr_mRNA_sig <- expr.mrna[, mRNA_age_anova$gene_id]
...
# Divide overall Anova coefs that are positive & negative
# See if all animals in 6/18 mo are always down or up





separate sig increase and decerased genes using coef values, the use go
