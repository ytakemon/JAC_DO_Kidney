...
write.csv(go_result, "./Pathways/RNA_EnrichGObp_Age.csv", row.names = FALSE)
# GO: CC
...
write.csv(go_result, "./Pathways/RNA_EnrichGOcc_Age.csv", row.names = FALSE)
...
write.csv(kegg_result, "./Pathways/RNA_EnrichKEGG_Age.csv", row.names = FALSE)
