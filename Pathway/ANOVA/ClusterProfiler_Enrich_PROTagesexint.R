...
sig <- AnovResults[AnovResults$sig.Prot_AgeSexInt == TRUE,]
...
write.csv(go_result, "./Pathways/PROT_EnrichGObp_AgeSexInt.csv", row.names = FALSE)
...
write.csv(go_result, "./Pathways/PROT_EnrichGOcc_AgeSexInt.csv", row.names = FALSE)
...
write.csv(kegg_result, "./Pathways/PROT_EnrichKEGG_AgeSexInt.csv", row.names = FALSE)
