...
# parameters
diffscan_dir <- "./QTLscan/scanBestMarker_protein/maxLODscan_Erk1_m"
...
ggplot(compare, aes(x=IntAgeLODDiff, Erk1MedLOD))+
  ...
  scale_y_continuous(name = "LOD score of (X | Erk1 mRNA)") +
  theme_bw()+
  labs(title = "Protein QTLscan @Chr7 w/ Erk1 mRNA mediation",
