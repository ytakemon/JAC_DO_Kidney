...
# parameters
diffscan_dir <- "./QTLscan/scanBestMarker_mrna/maxLODscan_Akt1_p"
...
# write table
write_csv(compare, "./QTLscan/scanBestMarker_mrna/maxLODscan_Akt1_p/scanBestMarker_m_Akt1_p_mediation_LODcomapre.csv")

# plot lod scores
pdf("./QTLscan/scanBestMarker_mrna/maxLODscan_Akt1_p/scanBestMarker_m_Akt1_p_mediation_LODcompare.pdf", width = 9, height = 9)
ggplot(compare, aes(x=IntAgeLODDiff, Akt1MedLOD))+
  ...
  theme_bw()+
  labs(title = "mRNA QTLscan @Chr12 w/ Akt1 protein mediation",
