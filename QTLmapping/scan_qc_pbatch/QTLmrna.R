...
intscan.dir.Sex <- "./QTLscan/intscan_mrna/Sex/"
...
output.file2 <- "./QTLscan/output/eQTLAllAdditive.csv"
output.file3 <- "./QTLscan/output/eQTLAllInteractiveAge.csv"
output.file4 <- "./QTLscan/output/eQTLAllInteractiveSex.csv"
