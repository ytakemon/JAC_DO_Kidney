...
best <- read.csv("./QTLscan/scanBestMarker_SexInt_protein/BestMarker_SexInt_BestperGene_protein.csv")

# check distribution of LOD scores
hist(best$IntSexLODDiff, breaks =100)
...
pdf(paste0("./QTLscan/scanBestMarker_SexInt_protein/BestMarker_SexInt_BestperGene_protein_thr",LODthreshold_diff,".pdf"), width = 9, heigh =10)
