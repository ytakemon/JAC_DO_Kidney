...
# parameters
addscan.dir <- "./QTLscan/addscan_prot_Pdgfb/"
intscan.dir.Age <- "./QTLscan/intscan_prot_Pdgfb/"
output.file1 <- "./QTLscan/output/pQTLBestperGeneAddPdgfbthr6_chr15.csv"
...
if (identical(list$id, list_add$id)){
  ...
  write.csv(compare, file="./QTLscan/output/pQTLintPdgfbthr6_chr15.csv", row.names = FALSE)
} else {
...
pdf("./QTLscan/output/plots/pQTL_PdgfbMediation_chr15_thr6.pdf", width = 9, heigh =9)
