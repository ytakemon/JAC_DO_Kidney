...
# parameters
diffscan_dir <- "./SNPscan/diffscansnp_prot_addErk1_p"
IntAge_output_file <- "./SNPscan/scan1snps_p_diffAgeInt_addErk1_p_BestperGene.csv"
...
compare <- initialLOD %>% mutate(
  Erk1_p_MedChr = medLOD$AgeIntChr,
  Erk1_p_MedPos = medLOD$AgeIntPos,
  Erk1_p_MedLOD = medLOD$AgeIntLOD,
  LODdrop = AgeIntLOD - Erk1_p_MedLOD
)
