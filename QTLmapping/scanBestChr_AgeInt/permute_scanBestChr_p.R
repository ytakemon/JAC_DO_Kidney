...
output_add <- output_full <- annot.protein[plist,]
...
file_add <- paste0("./QTLscan/scanBestChr_protein/perm/add/perm10scan_batch_",plist[1],".csv")
write_csv(output_add, path = file_add)

file_full <- paste0("./QTLscan/scanBestChr_protein/perm/full/perm10scan_batch_",plist[1],".csv")
