...
# parameters
addscan.dir <- "../addscan_prot/"
intscan.dir.Sex <- "../intscan_prot/Sex/"
intscan.dir.Age <- "../intscan_prot/Age/"
...
output.file1 <- "../output/pQTLBestperGene.csv"
output.file2 <- "../output/pQTLAllAdditive.csv"
output.file3 <- "../output/pQTLAllInteractiveAge.csv"
output.file4 <- "../output/pQTLAllInteractiveSex.csv"
